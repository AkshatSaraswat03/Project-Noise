    ...
    <div>
      <Row className='learn-content'>
        ...
        <Col lg={6} className='px-3'>
          ...
          <p>
            For more information please reach out to us on <span><a href='https://twitter.com/Prjctnoise' className='primary-text'>Twitter</a></span> or join the conversation in <span><a href='https://discord.gg/2AXCqUWX5J' className='primary-text'>Discord</a></span>.
          </p>
        </Col>
        <Col></Col>
        <Col lg={3}></Col>
